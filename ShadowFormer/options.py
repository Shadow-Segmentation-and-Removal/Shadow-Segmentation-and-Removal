...
class Options():
    ...
    def init(self, parser):
        ...
        parser.add_argument('--train_dir', type=str, default='/teamspace/studios/this_studio/SAM-Adapter-PyTorch/ISTD_Dataset/train', help='dir of train data')
        parser.add_argument('--val_dir', type=str, default='/teamspace/studios/this_studio/SAM-Adapter-PyTorch/ISTD_Dataset/test', help='dir of train data')
